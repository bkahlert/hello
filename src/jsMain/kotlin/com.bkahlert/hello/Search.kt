...
fun Search(
    ...
    val engineState = remember { mutableStateOf(Engine.values().random()) }
    ...
    Div({
        ...
        Div({ style { visuallyHidden() } }) {
            Span({
                ...
                style {
                    fontFamily("system-uix", "-apple-system", "Segoe UI", "Roboto", "Helvetica", "Arial", "sans-serif", "Apple Color Emoji", "Segoe UI Emoji")
                }
            })
        }
