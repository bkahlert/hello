...
interface ListElement : SemanticElement<HTMLDivElement>
...
@Suppress("unused")
val <TSemantic : ListElement> SemanticAttrsScope<TSemantic>.horizontal: Variation get() = Variation.Horizontal

/** [Inverted](https://semantic-ui.com/elements/list.html#inverted) variation of a [list](https://semantic-ui.com/elements/list.html). */
@Suppress("unused")
val <TSemantic : ListElement> SemanticAttrsScope<TSemantic>.inverted: Variation get() = Variation.Inverted
...
interface ListItemElement : SemanticElement<HTMLDivElement>
...
interface ListItemContentElement : SemanticElement<HTMLDivElement>
...
@Suppress("unused")
val <TSemantic : ListItemContentElement> SemanticAttrsScope<TSemantic>.verticallyAligned: Variation.VerticallyAligned
...
@Suppress("unused")
val <TSemantic : ListItemContentElement> SemanticAttrsScope<TSemantic>.floated: Variation.Floated get() = Variation.Floated
