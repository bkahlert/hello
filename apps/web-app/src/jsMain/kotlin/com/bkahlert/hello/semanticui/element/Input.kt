...
@Suppress("unused")
val <TSemantic : InputElement> SemanticAttrsScope<TSemantic>.transparent: Variation get() = Variation.Transparent
...
@Suppress("unused")
val <TSemantic : InputElement> SemanticAttrsScope<TSemantic>.inverted: Variation get() = Variation.Inverted

/** [Fluid](https://semantic-ui.com/elements/input.html#fluid) variation of a [input](https://semantic-ui.com/elements/input.html). */
@Suppress("unused")
val <TSemantic : InputElement> SemanticAttrsScope<TSemantic>.fluid: Variation get() = Variation.Fluid

/** [Size](https://semantic-ui.com/elements/input.html#size) variation of a [input](https://semantic-ui.com/elements/input.html). */
@Suppress("unused")
val <TSemantic : InputElement> SemanticAttrsScope<TSemantic>.size: Size get() = Variation.Size
