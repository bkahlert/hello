    ...
    popOver(id = "popOver") {
        popOverButton(
            ...
            opened.render { isOpen ->
                icon("w-5 h-5 ml-2 -mr-1", if (isOpen) MiniHeroIcons.chevron_up else MiniHeroIcons.chevron_down)
            }
        }
        ...
        popOverPanel(
            ...
            div("relative grid gap-8 p-7 lg:grid-cols-2") {
                solutions.forEach { item ->
                    a(
                        ...
                        div("ml-4") {
                            p("font-medium text-sm text-primary-900") { +item.name }
            ...
            div("flow-root p-4 transition duration-150 ease-in-out bg-primary-100") {
                span("flex items-center") {
                    span("font-medium text-sm text-primary-900") {
                        +"Advice"
                    }
                }
