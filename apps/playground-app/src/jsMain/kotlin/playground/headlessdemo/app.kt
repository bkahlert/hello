package playground.headlessdemo
...
import playground.headlessdemo.components.checkboxGroupDemo
import playground.headlessdemo.components.collectionDemo
import playground.headlessdemo.components.disclosureDemo
import playground.headlessdemo.components.inputFieldDemo
import playground.headlessdemo.components.listboxDemo
import playground.headlessdemo.components.menuDemo
import playground.headlessdemo.components.modalDemo
import playground.headlessdemo.components.popOverDemo
import playground.headlessdemo.components.radioGroupDemo
import playground.headlessdemo.components.switchDemo
import playground.headlessdemo.components.tabsDemo
import playground.headlessdemo.components.textAreaDemo
import playground.headlessdemo.components.toastDemo
import playground.headlessdemo.components.tooltipDemo
import playground.headlessdemo.foundation.testTrapFocus
import playground.tailwind.HeadlessUiIcons
...
data class DemoPage(val title: String, val description: String, val icon: Uri, override val content: ContentBuilder) : Page
