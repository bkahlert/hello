...
class HelloStack(
    ...
    val siteBucket = Bucket(
        this, "SiteBucket", BucketProps.builder()
    ...
    val userProps = UserProps(this, "UserProps", userPoolProvider.userPool)
        .export("UserPropsApiExecuteUrl", "URL of the execute API") { it.api.url }
    ...
    val siteBucketSourceConfiguration = SourceConfiguration.builder()
    ...
    val userPropsApiPathRewrite = Function.Builder.create(this, "user-props-api-path-rewrite").code(
        FunctionCode.fromInline(
            // language=javascript
            """
                function handler(event) {
    ...
    val userPropsApiSourceConfiguration = SourceConfiguration.builder()
        .customOriginSource(
            CustomOriginConfig.builder()
                .domainName(userProps.api.url.domain)
                .originPath(userProps.api.url.path)
            ...
            listOf(
                Behavior.builder()
                    ...
                    .pathPattern("/api/props*")
                    .functionAssociations(
                        listOf(
                            FunctionAssociation.builder()
                                .eventType(VIEWER_REQUEST)
                                .function(userPropsApiPathRewrite)
                                .build()
                        )
                    )
                    .build()
    ...
    val distribution = CloudFrontWebDistribution.Builder.create(this, "Distribution")
        ...
        .defaultRootObject("")
        .originConfigs(listOf(siteBucketSourceConfiguration, userPropsApiSourceConfiguration))
