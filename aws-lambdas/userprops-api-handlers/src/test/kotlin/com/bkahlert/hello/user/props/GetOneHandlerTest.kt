...
class GetOneHandlerTest {
    ...
    @ParameterizedTest
    @Event(value = "events/GetOne/get-item.json", type = APIGatewayProxyRequestEvent::class)
    ...
    @ParameterizedTest
    @Event(value = "events/GetOne/get-item.json", type = APIGatewayProxyRequestEvent::class)
    fun `should respond found item`(event: APIGatewayProxyRequestEvent, context: TestContext) = testAll {
        val ddbTable = dynamoContainer.asDynamoDbClientProvider().prepare {
