...
public object ImageFixtures {
    public val JohnDoe: String get() = JOHN
    public val Avatar: String get() = JOHN

    @Suppress("SpellCheckingInspection")
    public val KommonsLogo: SVGImage = SVGImage(
        """
    ...
    @Suppress("SpellCheckingInspection")
    public val PearLogo: SVGImage = SVGImage(
        """
...
public const val SPACER: String = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAA" +
    "ALAAAAAABAAEAAAIBRAA7"

@Suppress("SpellCheckingInspection", "JsonStandardCompliance")
public const val JOHN: String = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEAAAABACAMAA" +
