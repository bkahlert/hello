...
<svg xmlns="http://www.w3.org/2000/svg" aria-label="Empty avatar" role="img" cursor="default" width="60" height="60">
    <g style="transform: translateY(10px);">
        <g transform="matrix(1,0,0,-1,197.42373,1300.6102)" fill="black">
            <path d="M-142.4,1252.8c0-2.8-0.9-5.1-2.6-6.7c-1.7-1.6-4-2.5-6.9-2.5h-31c-2.9,0-5.2,0.8-6.9,2.5c-1.7,1.6-2.6,3.9-2.6,6.7
...
<svg xmlns="http://www.w3.org/2000/svg" aria-label="Empty avatar" role="img" cursor="default" width="60" height="60">
    <circle r="26" cx="30" cy="30" fill="none" stroke="grey" stroke-width="4" stroke-dasharray="3,12" stroke-linecap="round"/>
</svg>
"""
