 ...
 */
@Serializable
public data class OpenIDProviderMetadata(

    /**
     * URL using the https scheme with no query or fragment component that the OP asserts as its Issuer Identifier.
     * If Issuer discovery is supported (see [Section 2](https://openid.net/specs/openid-connect-discovery-1_0.html#IssuerDiscovery),
    ...
    public val responseModesSupported: List<String> = listOf("query", "fragment"),
    ...
    public val grantTypesSupported: List<String> = listOf("authorization_code", "implicit"),
    ...
    public val acrValuesSupported: List<String>?,
     ...
     * supported by the OP for the ID Token to encode the Claims in a [JWT](https://openid.net/specs/openid-connect-discovery-1_0.html#JWT).
    ...
    /**
     * JSON array containing a list of the [JWE](https://openid.net/specs/openid-connect-discovery-1_0.html#JWE) encryption algorithms (alg values)
     * supported by the OP for the ID Token to encode the Claims in a [JWT](https://openid.net/specs/openid-connect-discovery-1_0.html#JWT).
     */
    @SerialName("id_token_encryption_alg_values_supported")
    public val idTokenEncryptionAlgValuesSupported: List<String>?,

    /**
     * JSON array containing a list of the [JWE](https://openid.net/specs/openid-connect-discovery-1_0.html#JWE) encryption algorithms (enc values)
     * supported by the OP for the ID Token to encode the Claims in a [JWT](https://openid.net/specs/openid-connect-discovery-1_0.html#JWT).
     */
    @SerialName("id_token_encryption_enc_values_supported")
    public val idTokenEncryptionEncValuesSupported: List<String>?,

    /**
     * JSON array containing a list of the [JWS](https://openid.net/specs/openid-connect-discovery-1_0.html#JWS) signing algorithms (alg values)
     * [JWA](https://openid.net/specs/openid-connect-discovery-1_0.html#JWA) supported by the UserInfo Endpoint to encode the Claims in a
     * [JWT](https://openid.net/specs/openid-connect-discovery-1_0.html#JWT). The value none MAY be included.
     */
    @SerialName("userinfo_signing_alg_values_supported")
    public val userinfoSigningAlgValuesSupported: List<String>?,
    ...
    public val userinfoEncryptionAlgValuesSupported: List<String>?,
    ...
    public val userinfoEncryptionEncValuesSupported: List<String>?,
     ...
     * when it's passed by reference (using the request_uri parameter). Servers SHOULD support none and RS256.
     */
    @SerialName("request_object_signing_alg_values_supported")
    public val requestObjectSigningAlgValuesSupported: List<String>?,

    /**
     * JSON array containing a list of the [JWE](https://openid.net/specs/openid-connect-discovery-1_0.html#JWE) encryption algorithms (alg values)
     * supported by the OP for Request Objects. These algorithms are used both when the Request Object is passed by value and when it's passed by reference.
     */
    @SerialName("request_object_encryption_alg_values_supported")
    public val requestObjectEncryptionAlgValuesSupported: List<String>?,

    /**
     * JSON array containing a list of the [JWE](https://openid.net/specs/openid-connect-discovery-1_0.html#JWE) encryption algorithms (enc values)
     * supported by the OP for Request Objects. These algorithms are used both when the Request Object is passed by value and when it is passed by reference.
     */
    @SerialName("request_object_encryption_enc_values_supported")
    public val requestObjectEncryptionEncValuesSupported: List<String>?,
     ...
     * [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html#OpenID.Core). Other authentication methods MAY be defined by
     * extensions. If omitted, the default is client_secret_basic -- the HTTP Basic Authentication Scheme specified in Section 2.3.1 of
     * [OAuth 2.0](https://openid.net/specs/openid-connect-discovery-1_0.html#RFC6749).
     */
    @SerialName("token_endpoint_auth_methods_supported")
    public val tokenEndpointAuthMethodsSupported: List<String> = listOf("client_secret_basic"),

    /**
     * JSON array containing a list of the [JWS](https://openid.net/specs/openid-connect-discovery-1_0.html#JWS) signing algorithms (alg values)
     * supported by the Token Endpoint for the signature on the [JWT](https://openid.net/specs/openid-connect-discovery-1_0.html#JWT)
     * used to authenticate the Client at the Token Endpoint for the private_key_jwt and client_secret_jwt authentication methods. Servers SHOULD support RS256.
     * The value none MUST NOT be used.
     */
    @SerialName("token_endpoint_auth_signing_alg_values_supported")
    public val tokenEndpointAuthSigningAlgValuesSupported: List<String>?,

    /**
     * **Only specified in [OpenID Connect Provider Metadata](https://ldapwiki.com/wiki/Openid-configuration)**
     *
     * The fully qualified URL of the server's revocation endpoint defined by
     * [OAuth 2.0 Authorization Server Metadata](https://ldapwiki.com/wiki/OAuth%202.0%20Authorization%20Server%20Metadata)
     ...
     * These values are described in Section 3.1.2.1 of [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html#OpenID.Core).
     */
    @SerialName("display_values_supported")
    public val displayValuesSupported: List<String>?,

    /**
     * JSON array containing a list of the Claim Types that the OpenID Provider supports.
     * These Claim Types are described in Section 5.6 of [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html#OpenID.Core).
    ...
    public val claimTypesSupported: List<String>?,
    ...
    public val claimsSupported: List<String>?,
     ...
     * In particular, if the OpenID Provider doesn't support Dynamic Client Registration, then information on how to register Clients needs to be provided in
     * this documentation.
     */
    ...
    /**
     * Languages and scripts supported for values in Claims being returned, represented as a JSON array of
     * [BCP47](https://openid.net/specs/openid-connect-discovery-1_0.html#RFC5646) language tag values.
     * Not all languages and scripts are necessarily supported for all Claim values.
     */
    @SerialName("claims_locales_supported")
    public val claimsLocalesSupported: List<String>?,
    ...
    public val uiLocalesSupported: List<String>?,
    ...
    public val claimsParameterSupported: Boolean = false,
    ...
    public val requestParameterSupported: Boolean = false,
    ...
    public val requestUriParameterSupported: Boolean = true,
    ...
    public val requireRequestUriRegistration: Boolean = false,
